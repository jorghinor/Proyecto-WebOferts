...
<head>
    ...
    <title>Webofertas Bolivia</title>

    <!-- <link rel="stylesheet" type="text/css" href="assets/css/bootstrap.min.css"> -->
    <link rel="stylesheet" type="text/css" href="{{ URL::to('assets/css/bootstrap.min.css') }} ">

    <link rel="stylesheet" type="text/css" href="{{ URL::to('assets/fonts/line-icons.css') }}">

    <link rel="stylesheet" type="text/css" href="{{ URL::to('assets/css/slicknav.css') }}">

    <!-- <link rel="stylesheet" type="text/css" href="assets/css/color-switcher.css"> -->

    <link rel="stylesheet" type="text/css" href="{{ URL::to('assets/css/nivo-lightbox.css') }}">
    ...
    <link rel="stylesheet" id="colors" href="{{ URL::to('assets/css/colors/pink.css') }}" type="text/css">
    ...
    <style>
        ...
        .top-nav-collapse {
            ...
            border-bottom: 1px solid rgba(255, 176, 214, 0.44) !important;
            backdrop-filter: blur(12px) saturate(130%);
            -webkit-backdrop-filter: blur(12px) saturate(130%);
            box-shadow: 0 8px 24px rgba(85, 33, 60, 0.18) !important;
        }
        .top-nav-collapse .nav-link {
            color: #513042 !important;
        }
        .top-nav-collapse .tg-btn {
            box-shadow: 0 6px 14px rgba(123, 43, 88, 0.24);
        }
        /* Fix para que v-app no rompa el layout existente */
        .v-application--wrap {
...
<body>
                    ...
                    <div class="container">
                        ...
                        <div class="navbar-header">
                            ...
                            <a href="{{ url('/') }}" class="navbar-brand">
                                <video src="{{ url('assets/img/animacioncr.mp4') }}" autoplay loop muted playsinline style="width: 200px; border-radius: 10px; mix-blend-mode: multiply; opacity: 0.9; box-shadow: 0 0 20px rgba(233, 30, 99, 0.4);"></video>
                            </a>
                        </div>
                        <div class="collapse navbar-collapse" id="main-navbar">
                            ...
                            <ul class="sign-in">
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="lni-user"></i> Mi Cuenta</a>
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="account-close.html"><i class="lni-close"></i>Account close xxx</a>
                                        <a class="dropdown-item" href="{{ url('login') }}">{{ __('Login') }}</a>
                                        <a class="dropdown-item" href="{{ url('registro') }}">{{ __('Register') }}</a>
                                    </div>
                                </li>
                            </ul>
                            <a class="tg-btn" href="{{ url('login') }}">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                                <div class="widget">
                                    <h3 class="footer-logo"><img src="{{ url('assets/img/logo.png')}}" alt=""></h3>
                                    ...
                                    <ul class="media-content-list">
                                        <li>
                                            <div class="media-left">
                                                <img class="img-fluid" src="{{ url('assets/img/art/img1.jpg')}}" alt="">
                                                <div class="overlay">
                                        ...
                                        <li>
                                            <div class="media-left">
                                                <img class="img-fluid" src="{{ url('assets/img/art/img2.jpg')}}" alt="">
                                                <div class="overlay">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="float-right">
                                    <ul class="bottom-card">
                                        <li>
                                            <a href="#"><img src="{{url('assets/img/footer/card1.jpg')}}" alt="card"></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{url('assets/img/footer/card2.jpg')}}" alt="card"></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{url('assets/img/footer/card3.jpg')}}" alt="card"></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{url('assets/img/footer/card4.jpg')}}" alt="card"></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <script src="{{ URL::to('assets/js/jquery-min.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script>
    <!-- <script src="{{url('assets/js/popper.min.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script> -->
    <script src="{{ URL::to('assets/js/bootstrap.min.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script>
    <!-- <script src="{{url('assets/js/color-switcher.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script> -->
    <script src="{{ URL::to('assets/js/jquery.counterup.min.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script>
    <script src="{{ URL::to('assets/js/waypoints.min.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script>
    <script src="{{ URL::to('assets/js/wow.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script>
    <script src="{{ URL::to('assets/js/owl.carousel.min.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script>
    <script src="{{ URL::to('assets/js/nivo-lightbox.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script>
    <script src="{{ URL::to('assets/js/jquery.slicknav.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script>
    <script src="{{ URL::to('assets/js/main.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script>
    <script src="{{ URL::to('assets/js/form-validator.min.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script>
    <script src="{{ URL::to('assets/js/contact-form-script.min.js') }}" type="e661b45760c7a8ed4d13306c-text/javascript"></script>
    <script src="{{ URL::to('assets/js/summernote.js')}}" type="e661b45760c7a8ed4d13306c-text/javascript"></script>
    <script src="{{ URL::to('assets/js/rocket-loader.min.js') }}" data-cf-settings="e661b45760c7a8ed4d13306c-|49" defer=""></script>
